...
def main():
    ...
    parser.add_argument('--checkpoint-path',type= str, default='./checkpoint/s_SUN9w_t_CT_resnet50_moco/',
    ...
    parser.add_argument('--root-dir',type=str,default='../../../../../../datasets/target/covid_ct/')
    ...
    trainset = dataCT.CovidCTDataset(root_dir=args.root_dir,
                              ...
                              transform=transforms.Compose(
                                  [transforms.RandomResizedCrop(224, scale=(0.6, 1.2)),
