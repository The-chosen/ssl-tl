...
def main():
    ...
    parser.add_argument('--epoch',type = int ,default=300, help='Maximum training epoch')
    ...
    # NEED TO CHANGE
    parser.add_argument('--transfer-resume', type=str, default='../../../ssl/moco/checkpoints/checkpoint_1/checkpoint_0980.pth.tar',# ./checkpoint/inat_resnet50_tl/best.pth.tar
                        help='Path to load transfering pretrained model')
    parser.add_argument('--checkpoint-path',type = str, default='../checkpoints/ssl/flower/1',
    ...
    parser.add_argument('--root-dir', type=str, default='../../../../../../datasets/target/',
    ...
    parser.add_argument('--PRINT-INTERVAL', type=int, default=4, help='Number of batch to print the loss')
...
#     valset = ImageFolder(
#         root=os.path.join(args.root_dir, 'valid'),
...
#         }
#         model = MODEL_DICT['resnet50'](num_classes=257, pretrained=False)
        
#         for name, param in model.named_parameters():
#             param.requires_grad = True

#         checkpoint = torch.load('../../../ssl/moco/checkpoints/checkpoint_1/checkpoint_0980.pth.tar', map_location="cpu")
