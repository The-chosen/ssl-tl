...
class ImageNetDataset(data.Dataset):
    ...
    def __init__(self, root,number_per_class,mode = 'train',transforms=None):
...
def main():
    ...
    parser.add_argument('--checkpoint-path',type = str, default='./checkpoint/imagnet_resnet50_tl0.01/',
    ...
    parser.add_argument('--resume', type = str, default='./checkpoint/imagnet_resnet50_tl0.01/best.pth.tar',
                        help='Path to resume a checkpoint')
    parser.add_argument('--num-class', type = int, default=987, help='Number of class for the classification')
    ...
    trainset = ImageNetDataset(root=args.root_dir,number_per_class=10,transforms=train_trans)
    ...
    val_loader = DataLoader(valset, batch_size=64,num_workers=8,pin_memory=True)
