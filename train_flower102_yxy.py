...
def main():
    ...
    parser.add_argument('--checkpoint-path',type= str, default='./checkpoint/s_SUN9w_t_flower102_resnet50_moco/',
    ...
    parser.add_argument('--transfer-resume', type=str, default='../ssl/moco/SUN9w/checkpoint_0135.pth.tar',
                        help='Path to load transfering pretrained model')
    parser.add_argument('--resume', type = str, default='./checkpoint/s_rand_t_flower102_resnet50_tl/best.pth.tar',
