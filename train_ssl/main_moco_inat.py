...
parser.add_argument('--root-dir', type=str, default='../../data/images/',
                        help='path to dataset')
...
parser.add_argument('--save-path',default='inat_resnet50',type=str)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = INAT(root = args.root_dir,
