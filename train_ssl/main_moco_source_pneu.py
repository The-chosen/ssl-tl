...
parser.add_argument('--ann_file', default='../../../../../datasets/nih/NIH_train.csv', type=str,
                    help='path to csvfile')
parser.add_argument('--root-dir', type=str, default='../../../../../datasets/target/xray/chest_xray/chest_xray/train/',
...
#                                     transforms=moco.loader.TwoCropsTransform(transforms.Compose(augmentation)))
    trainset = datasets.ImageFolder(root=args.root_dir,
