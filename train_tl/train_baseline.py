...
def main():
    ...
    parser.add_argument('--checkpoint-path',type = str, default='./checkpoints/checkpoint_baseline/',
    ...
    parser.add_argument('--logpath', type=str, default='./logs/log_baseline', help='log path')
    ...
    trainset = RgrDataset('ct.csv', args.train_dir, args.augement, transform=train_trans, root_dir_results = None)
