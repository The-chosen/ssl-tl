...
def main():
    ...
    parser.add_argument('--checkpoint-path',type = str, default='./checkpoint/inat_resnet50_tl/',
    ...
    parser.add_argument('--root-dir', type=str, default='/tmp/data/',
    ...
    parser.add_argument('--schedule', default=[30, 120], nargs='*', type=int,
    ...
    parser.add_argument('--resume', type = str, default='./checkpoint/inat_resnet50_tl/best.pth.tar',
    ...
    trainset = INAT_balance(root=args.root_dir,ann_file=args.train_json,
    ...
    val_loader = DataLoader(valset, batch_size=128,num_workers=8,pin_memory=True)
    ...
    # weight = 1/trainset.weight
    # weight /= np.sum(trainset.weight)
