...
class PetCTDataset(Dataset):
    ...
    def __init__(self, pet_csv, ct_csv, pet_root_dir, ct_root_dir, transform=None):
        ...
        self.pet_imgs = [os.join(self.pet_imgs_pth, img) for img in os.path.listdir(self.pet_imgs_pth)]
        self.pet_number = len(self.pet_imgs)
        
        self.ct_imgs_pth = ct_root_dir
        self.ct_imgs = [os.join(self.ct_imgs_pth, img) for img in os.path.listdir(self.ct_imgs_pth)]
