...
def main():
    ...
    parser.add_argument('--checkpoint-path',type= str, default='./checkpoint/s_inat_t_flower102_resnet50_tl/',
    ...
    parser.add_argument('--transfer-resume', type=str, default='../ssl/moco/inat_resnet50/checkpoint_0048.pth.tar',
