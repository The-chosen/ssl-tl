...
def main():
    ...
    parser.add_argument('--checkpoint-path',type = str, default='./checkpoint/inat_resnet50_tl0.1/',
    ...
    parser.add_argument('--transfer-resume', type=str, default='./checkpoint/inat_resnet50_tl/best.pth.tar',
                        help='Path to load transfering pretrained model')
    parser.add_argument('--resume', type = str, default='./checkpoint/inat_resnet50_tl0.1/best.pth.tar',
    ...
    # LOSS_FUNC = LabelSmoothSoftmaxCE(lb_smooth=0.1).to(device)
