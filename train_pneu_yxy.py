...
def main():
    ...
    parser.add_argument('--checkpoint-path',type= str, default='./checkpoint/s_SUN_t_Xray_resnet50_tl/',
    ...
    parser.add_argument('--train-dir',type=str,default='../../../../../../datasets/target/xray/chest_xray/chest_xray/train')
    parser.add_argument('--val-dir',type=str,default='../../../../../../datasets/target/xray/chest_xray/chest_xray/val')
    parser.add_argument('--test-dir',type=str,default='../../../../../../datasets/target/xray/chest_xray/chest_xray/test')
    ...
    parser.add_argument('--transfer-resume', type=str, default='./checkpoint/100%sl_pretrain.pth.tar',# ../ssl/moco/pnuemonia_target/checkpoint_0200.pth.tar
...
#                 assert set(msg.missing_keys) == {"fc.weight", "fc.bias"}
    ...
    for epoch in range(args.start_epoch, args.epoch):
        ...
        if epoch % 5 == 0:
            ...
            print('ACC TEST:', acc1)
            f = open('result_pneu.txt', 'a')
            f.write('===============================================')
            f.write('COMMAND: ' + str(args) + '\n')
            f.write('Epoch: ' + str(epoch) + '\n')
            f.write('ACC TEST: ' + str(acc1) + '\n')
            f.close()
